...
def pandas_split(path,per=0.4):
	...
	df_test.to_csv('./mirflickr25k_test_' + str(per*10) + '.csv')
...
def get_mirflickr25k(inp_dir, data_dir):
	trainset = MirFlickr25kPreProcessing(data_dir, set='train', inp_name=inp_dir)
